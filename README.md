...
# Installation
Download the [latest release](https://github.com/pistakilla/Xytox-Ammomatic/releases/download/1.8/xytox_ammomatic_v1.8.zip) and extract contents to `%localappdata%\Plutonium\storage\t5`
